 ...
 */
export declare const createAccessToken: (secret: string, expiresIn: number, data: object) => Promise<IAccessToken>;
/**
 ...
 * @category Authorization
 */
export declare const getAccessTokenData: (token: string, secret: string) => any;
